...
export class Logo extends React.Component {
    render () {
        return (
            <>          
            <Tween wrapper={<div id="primary-logo" className="logo-wrapper"/>} to={{height: 0, opacity: 0, rotation: -45}} delay={4} duration={1} ease={"Strong.easeOut"} 
                onComplete={
                    function() {
                        document.getElementById('primary-logo').classList.add("after-initial-load")
                        const svgClass = document.getElementById('logo-svg').classList
                        svgClass.add("svg-after-initial-load")
                    }
                }
            > 
                <svg id="logo-svg" data-name="Logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 757.28 735.76" style={{width: "100px"}}>
                    <clipPath id="l-rect-clip">
                        <path fill="#fff" d="M389.4 0 389.4 32.11 725.17 367.88 389.4 703.66 389.4 735.76 757.28 367.88 389.4 0Z" />
                    </clipPath>
                    <clipPath id="r-rect-clip">
                        <path fill="#f1c85f" d="M367.88 703.66 32.11 367.88 367.88 32.11 367.88 0 0 367.88 367.88 735.76 367.88 703.66Z" />
                    </clipPath>
                    <clipPath id="j-clip">
