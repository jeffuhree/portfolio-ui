                ...
                <ul id="nav-inner">
                    ...
                    <li>
                        <a onClick={ () => this.props.fullpageApi.moveTo(2) }> 
                            <svg style={{opacity: 0.8}} id="nav-about-page" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" >
                    ...
                    <li>
                        <a onClick={ () => this.props.fullpageApi.moveTo(3) }> 
                            <svg style={{opacity: 0.6}} id="nav-work-page" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" >
                    ...
                    <li>
                        <a onClick={ () => this.props.fullpageApi.moveTo(5) }> 
                            <svg style={{opacity: 0.2}} id="nav-project-page" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
