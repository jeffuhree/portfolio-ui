...
export class Navigation extends React.Component {
    ...
    onUnhoverNav() {
        ...
        timeline.fromTo("#main-nav-icon", 1, 
        {
            display: "none",
            scale: 0,
            rotate: -90,
                ...
                <ul id="nav-inner">
                    ...
                    <li>
                        <a onClick={ () => this.props.fullpageApi.moveTo(2) }> 
                            <svg id="nav-about-page" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" >
                    ...
                    <li>
                        <a onClick={ () => this.props.fullpageApi.moveTo(3) }> 
                            <svg id="nav-work-page" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" >
                    ...
                    <li>
                        <a onClick={ () => this.props.fullpageApi.moveTo(4) }> 
                            <svg id="nav-edu-page" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
                    ...
                    <li>
                        <a onClick={ () => this.props.fullpageApi.moveTo(5) }> 
                            <svg id="nav-project-page" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
