    ...
    render () {
        return (
            ...
            <div id="main-nav-icon"
                onMouseEnter={ this.hover } onMouseLeave={ this.unhover } onClick={ this.click }
            >
...
export class Navigation extends React.Component {
    ...
    onHover(button) {
        TweenMax.to(button.children[0], 0.2, {fill: "#f1c85f"});  
    }

    onUnhover(button) {
        TweenMax.to(button.children[0], 0.2, {fill: "#efefef"});
    }
